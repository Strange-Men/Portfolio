...
| v1.28.1-projects-contact-link | — | Phase 8-2 / 8-2.1 | 修复 Contact Email 按钮 mailto 链接，新增 EnterpriseAiDataAgent 和 Basjoo 二开项目卡片，Projects 区域调整为三个项目平级展示，补齐所有项目链接，优化 Hero 背景质感。 |
